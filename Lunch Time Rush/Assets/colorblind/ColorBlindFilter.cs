...
public class ColorBlindFilter : MonoBehaviour
{
    ...
    {
        { new Color(.299f, .587f, .114f), new Color(.299f, .587f, .114f), new Color(.299f, .587f, .114f)},    // Normal
        ...
        { new Color(1f,0f,0f),   new Color(0f,1f,0f), new Color(0f,0f,1f) },   // Achromatopsia
